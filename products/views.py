...
class PostAd(ActiveUserRequiredMixin, View):
...
class UpdateProduct(ActiveUserRequiredMixin, generic.edit.UpdateView):
    model = Product
    fields = ['title', 'price', 'description', 'brand']
...
class DeleteAdd(ActiveUserRequiredMixin, View):
    def get(self, request, *args, **kwargs):
        product_id = kwargs.get('id')
        product_obj = get_object_or_404(Product, id=product_id)

        product_obj.delete()
        messages.success(request, f'{product_obj.title} Deleted Successfully')
