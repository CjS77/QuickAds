...
class Dashboard(ActiveUserRequiredMixin, View):
...
class UpdateProfile(ActiveUserRequiredMixin, View):
...
class ChangePassword(ActiveUserRequiredMixin, View):
    def get(self, request, *args, **kwargs):
